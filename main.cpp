...
//Se pide imprimir esta tabla desde 1 al 12
cout<<"\nla tabla del 8";
cout<<tabla,
for(i=1, 1<=12, i++)
{
...
//4. calcular la sumatoria de los numeros comprendidos entr 500 y 800
int suma=0;
for(i=500; i<=800, i++)
{
suma = suma + i
...
//se piden por teclado 2 enteros que representan el principio y fin
